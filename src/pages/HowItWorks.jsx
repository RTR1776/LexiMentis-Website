    ...
    <div className="bg-gray-50 dark:bg-gray-900 py-20">
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">How Our AI Workers Comp System Works</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-md border border-gray-100 dark:border-gray-700 flex flex-col">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Specialized Knowledge Base</h3>
            ...
            <div className="text-sm font-medium text-blue-600 dark:text-blue-400">Comprehensive • Current • State-Specific</div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-md border border-gray-100 dark:border-gray-700 flex flex-col">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Document Processing</h3>
            <p className="text-gray-600 dark:text-gray-300 mb-4 flex-grow">
            ...
            <div className="text-sm font-medium text-blue-600 dark:text-blue-400">Fast • Accurate • Secure</div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-md border border-gray-100 dark:border-gray-700 flex flex-col">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">RAG Technology</h3>
            <p className="text-gray-600 dark:text-gray-300 mb-4 flex-grow">
            ...
            <div className="text-sm font-medium text-blue-600 dark:text-blue-400">Contextual • Relevant • Evidence-Based</div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-md border border-gray-100 dark:border-gray-700 flex flex-col">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Multi-Model Approach</h3>
            <p className="text-gray-600 dark:text-gray-300 mb-4 flex-grow">
              Different AI models handle specialized tasks like medical record analysis, document extraction, and legal form preparation.
            </p>
            <div className="text-sm font-medium text-blue-600 dark:text-blue-400">Specialized • Optimized • Efficient</div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-md border border-gray-100 dark:border-gray-700 flex flex-col">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Automated Forms & Profiles</h3>
            <p className="text-gray-600 dark:text-gray-300 mb-4 flex-grow">
            ...
            <div className="text-sm font-medium text-blue-600 dark:text-blue-400">Time-Saving • Standardized • Thorough</div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-md border border-gray-100 dark:border-gray-700 flex flex-col">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Interactive Assistance</h3>
            <p className="text-gray-600 dark:text-gray-300 mb-4 flex-grow">
            ...
            <div className="text-sm font-medium text-blue-600 dark:text-blue-400">Responsive • Educational • Actionable</div>
          </div>
        </div>
