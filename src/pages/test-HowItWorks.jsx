I'll help you revamp the HowItWorks.jsx component to focus on integrating the Model Context Protocol (MCP) into your workers compensation platform. Given your background in legal operations and your focus on LexiMentis as an MCP-powered solution, this makes perfect sense!

Here's a revised version of the HowItWorks page that emphasizes MCP integration:

```jsx
import React from 'react';
import { Link } from 'react-router-dom';
import { Database, FileText, Brain, Cpu, ClipboardCheck, MessageSquare, Code, Network, Lock, Zap } from 'lucide-react';
...
const HowItWorks = () => {
  return (
    <div className="bg-neutral-50 dark:bg-secondary-900 min-h-screen">
      ...
      <div className="py-16 bg-white dark:bg-secondary-800">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-secondary-900 dark:text-neutral-white mb-6">The Model Context Protocol Advantage</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="flex flex-col items-center text-center md:items-start md:text-left">
              ...
              <h3 className="text-2xl font-bold text-secondary-900 dark:text-neutral-white mb-4">Seamless AI Integration</h3>
            ...
            <div className="flex flex-col items-center text-center md:items-start md:text-left">
              ...
              <h3 className="text-2xl font-bold text-secondary-900 dark:text-neutral-white mb-4">Secure Data Handling</h3>
              <p className="text-secondary-600 dark:text-neutral-300">
      ...
      <div className="py-16 bg-accent-50 dark:bg-accent-900/10">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-secondary-900 dark:text-neutral-white mb-6">LexiMentis MCP Architecture</h2>
            <p className="text-lg text-secondary-600 dark:text-neutral-300 max-w-3xl mx-auto">
          ...
          <div className="bg-white dark:bg-secondary-800 p-8 rounded-xl shadow-lg mb-12">
            <div className="h-64 w-full flex items-center justify-center border-2 border-dashed border-accent-200 dark:border-accent-800 rounded-lg">
              <p className="text-accent-600 dark:text-accent-400 font-medium">MCP Architecture Diagram</p>
      ...
      <div className="py-16 bg-white dark:bg-secondary-800">
        <div className="container mx-auto px-6 max-w-6xl">
          <h2 className="text-3xl font-bold text-secondary-900 dark:text-neutral-white mb-12 text-center">Our Specialized MCP Servers</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-neutral-white dark:bg-secondary-800 rounded-xl p-8 shadow-md border border-neutral-200 dark:border-secondary-700 flex flex-col">
              ...
              <h3 className="text-xl font-bold text-secondary-900 dark:text-neutral-white mb-3">Document MCP</h3>
            ...
            <div className="bg-neutral-white dark:bg-secondary-800 rounded-xl p-8 shadow-md border border-neutral-200 dark:border-secondary-700 flex flex-col">
              ...
              <h3 className="text-xl font-bold text-secondary-900 dark:text-neutral-white mb-3">Knowledge Base MCP</h3>
              <p className="text-secondary-600 dark:text-neutral-300 mb-4 flex-grow">
            ...
            <div className="bg-neutral-white dark:bg-secondary-800 rounded-xl p-8 shadow-md border border-neutral-200 dark:border-secondary-700 flex flex-col">
              ...
              <h3 className="text-xl font-bold text-secondary-900 dark:text-neutral-white mb-3">Medical Analysis MCP</h3>
              <p className="text-secondary-600 dark:text-neutral-300 mb-4 flex-grow">
            ...
            <div className="bg-neutral-white dark:bg-secondary-800 rounded-xl p-8 shadow-md border border-neutral-200 dark:border-secondary-700 flex flex-col">
              ...
              <h3 className="text-xl font-bold text-secondary-900 dark:text-neutral-white mb-3">Forms MCP</h3>
              <p className="text-secondary-600 dark:text-neutral-300 mb-4 flex-grow">
            ...
            <div className="bg-neutral-white dark:bg-secondary-800 rounded-xl p-8 shadow-md border border-neutral-200 dark:border-secondary-700 flex flex-col">
              ...
              <h3 className="text-xl font-bold text-secondary-900 dark:text-neutral-white mb-3">Workflow MCP</h3>
              <p className="text-secondary-600 dark:text-neutral-300 mb-4 flex-grow">
            ...
            <div className="bg-neutral-white dark:bg-secondary-800 rounded-xl p-8 shadow-md border border-neutral-200 dark:border-secondary-700 flex flex-col">
              ...
              <h3 className="text-xl font-bold text-secondary-900 dark:text-neutral-white mb-3">Assistant MCP</h3>
              <p className="text-secondary-600 dark:text-neutral-300 mb-4 flex-grow">
      ...
      <div className="py-16 bg-accent-50 dark:bg-accent-900/10">
        <div className="container mx-auto px-6 max-w-6xl">
          <h2 className="text-3xl font-bold text-secondary-900 dark:text-neutral-white mb-12 text-center">How It Works in Practice</h2>
      ...
      <div className="py-16 bg-white dark:bg-secondary-800">
        <div className="container mx-auto px-6 max-w-3xl text-center">
          <h2 className="text-3xl font-bold text-secondary-900 dark:text-neutral-white mb-6">Ready to Transform Your Workers Comp Practice?</h2>
          <p className="text-lg text-secondary-600 dark:text-neutral-300 mb-8">
            Experience the power of Model Context Protocol and LexiMentis' specialized AI ecosystem for yourself.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link to="/demo" className="px-8 py-4 bg-accent-800 hover:bg-accent-700 text-white font-medium rounded-lg shadow-lg transition duration-200">
              Try the AI Demo
            </Link>
            <Link to="/book" className="px-8 py-4 bg-primary-500 hover:bg-primary-600 text-white font-medium rounded-lg shadow-lg transition duration-200">
              Book a Full Demo
            </Link>
          </div>
        </div>
